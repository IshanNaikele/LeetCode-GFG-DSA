...
int main()
{
    ...
    Node *prev2=NULL;
    deleteAtStart(temp2);
    cout<<"Printing Doubly Linked List after deleting at start  through next pointer :";
    while(temp2)
    {
      cout<<temp2->data<<" ";
      prev2=temp2;
    ...
    cout<<endl;
    cout<<"Printing Doubly Linked List after deleting at start  through prev pointer :";
    while(prev2)
    {
        cout<<prev2->data<<" ";
        prev2=prev2->prev;
